...
const CreateQuotationPage: React.FC = () => {
  const { customers, products, taxes, addQuotation, quotations } = useData();
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Create Quotation</h1>
        <div className="flex space-x-2">
            <Button variant="outline" onClick={() => handleSave(QuotationStatus.Draft)}>Save as Draft</Button>
            <Button onClick={() => handleSave(QuotationStatus.Sent)}>Save & Send</Button>
        </div>
      </div>
