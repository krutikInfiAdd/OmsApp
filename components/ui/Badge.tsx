...
import { InvoiceStatus, SalesOrderStatus, PurchaseOrderStatus, QuotationStatus, CreditDebitNoteStatus, GRNStatus } from '../../types';

type Status = InvoiceStatus | SalesOrderStatus | PurchaseOrderStatus | QuotationStatus | CreditDebitNoteStatus | GRNStatus;
