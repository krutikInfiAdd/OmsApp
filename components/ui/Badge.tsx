...
export const Badge: React.FC<BadgeProps> = ({ status }) => {
  ...
  const statusClasses: Record<string, string> = {
    ...
    // Fix: Removed duplicate property 'Completed'. This key is already defined by GRNStatus.Completed.
    // The string value for both `GRNStatus.Completed` and `ProductionOrderStatus.Completed` is 'Completed'.
    // [ProductionOrderStatus.Completed]: 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300',
    // Fix: Removed duplicate property 'Cancelled'. This key is already defined by SalesOrderStatus.Cancelled.
    // The string value for both `SalesOrderStatus.Cancelled` and `ProductionOrderStatus.Cancelled` is 'Cancelled'.
    // [ProductionOrderStatus.Cancelled]: 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
  };
