    ...
    <div className="bg-white p-12 text-gray-800" style={{ width: '794px', minHeight: '1123px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <header className="flex justify-between items-start pb-4 mb-4 border-b">
        ...
        <div className="text-right">
          <h2 className="text-4xl font-bold uppercase" style={{color: '#1e3a8a'}}>QUOTATION</h2>
          <table className="text-xs mt-2 w-full">
            <tbody>
              <tr>
                <td className="font-semibold text-gray-600 text-right pr-2">Quotation #:</td>
                <td className="text-gray-800">{quotation.quotationNumber}</td>
              </tr>
              <tr>
                <td className="font-semibold text-gray-600 text-right pr-2">Date:</td>
                <td className="text-gray-800">{quotation.issueDate}</td>
              </tr>
              <tr>
                <td className="font-semibold text-gray-600 text-right pr-2">Expiry Date:</td>
                <td className="text-gray-800">{quotation.expiryDate}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <main>
        <div className="mb-6">
          <div className="text-xs font-semibold uppercase text-gray-500 mb-1">QUOTATION FOR</div>
          <div className="font-bold text-base text-gray-800">{quotation.customer.name}</div>
          <div className="text-xs text-gray-600">{quotation.customer.address}</div>
          <div className="text-xs text-gray-600">{quotation.customer.city}, {quotation.customer.state}</div>
          <div className="text-xs text-gray-600">GSTIN: {quotation.customer.gstin}</div>
        </div>
